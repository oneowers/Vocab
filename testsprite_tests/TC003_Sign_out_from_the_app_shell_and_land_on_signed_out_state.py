...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields, then submit the login form (click the Log in button).
        ...
        # -> Authenticate by filling the email and password fields and submitting the login form.
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div[2]/main/div/div[2]/form/div/input').nth(0)
        await asyncio.sleep(3); await elem.fill('kamolov1575@gmail.com')

...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password into the visible inputs (indexes 551 and 559) and click the Log in button (index 565). After submit, verify redirection to the dashboard and presence of Daily Quest and streak/progress information.

...
export const GRAMMAR_TOPICS: Record<string, GrammarTopicContent> = {
  ...
  present_continuous: {
    ...
    exercises: [{ id: "pc1", type: "multiple_choice", topicKey: "present_continuous", question: "They ___ now.", options: [{ id: "a", text: "play", isCorrect: false }, { id: "b", text: "are playing", isCorrect: true }] }]
  },
  plural_nouns: {
    key: "plural_nouns",
  ...
  articles_basic: {
    ...
    exercises: [{ id: "ar1", type: "multiple_choice", topicKey: "articles_basic", question: "I see ___ sun.", options: [{ id: "a", text: "a", isCorrect: false }, { id: "b", text: "the", isCorrect: true }] }]
  },
  prepositions_basic: {
    ...
    exercises: [{ id: "pr1", type: "multiple_choice", topicKey: "prepositions_basic", question: "___ 5 o'clock.", options: [{ id: "a", text: "In", isCorrect: false }, { id: "b", text: "At", isCorrect: true }] }]
  },
  there_is_are: {
    key: "there_is_are",
  ...
  pronouns_possessives: {
    ...
    exercises: [{ id: "prn1", type: "multiple_choice", topicKey: "pronouns_possessives", question: "It is ___ car.", options: [{ id: "a", text: "me", isCorrect: false }, { id: "b", text: "my", isCorrect: true }] }]
  },
  word_order_basic: {
  ...
  past_continuous: {
    ...
    exercises: [{ id: "paco1", type: "multiple_choice", topicKey: "past_continuous", question: "He ___ at 5.", options: [{ id: "a", text: "was working", isCorrect: true }, { id: "b", text: "were working", isCorrect: false }] }]
  },
  future_simple: {
    key: "future_simple",
  ...
  going_to: {
    ...
    exercises: [{ id: "gt1", type: "multiple_choice", topicKey: "going_to", question: "She ___ visit us.", options: [{ id: "a", text: "is going to", isCorrect: true }, { id: "b", text: "will going to", isCorrect: false }] }]
  },
  countable_uncountable: {
    ...
    exercises: [{ id: "cu1", type: "multiple_choice", topicKey: "countable_uncountable", question: "How ___ money?", options: [{ id: "a", text: "many", isCorrect: false }, { id: "b", text: "much", isCorrect: true }] }]
  },
  ...
  modal_can_should_must: {
    ...
    exercises: [{ id: "mc1", type: "multiple_choice", topicKey: "modal_can_should_must", question: "You ___ study.", options: [{ id: "a", text: "should", isCorrect: true }, { id: "b", text: "should to", isCorrect: false }] }]
  },
  adverbs_basic: {
    key: "adverbs_basic",
    titleEn: "Adverbs",
  ...
  present_perfect: {
    ...
    exercises: [{ id: "pp1", type: "multiple_choice", topicKey: "present_perfect", question: "Have you ___?", options: [{ id: "a", text: "ate", isCorrect: false }, { id: "b", text: "eaten", isCorrect: true }] }]
  },
  conditionals_0_1: {
    ...
    exercises: [{ id: "c01", type: "multiple_choice", topicKey: "conditionals_0_1", question: "If he ___ help.", options: [{ id: "a", text: "comes", isCorrect: true }, { id: "b", text: "will come", isCorrect: false }] }]
  },
  ...
  reported_speech_basic: {
    ...
    exercises: [{ id: "rs1", type: "multiple_choice", topicKey: "reported_speech_basic", question: "He said he ___ happy.", options: [{ id: "a", text: "is", isCorrect: false }, { id: "b", text: "was", isCorrect: true }] }]
  },
  ...
  past_perfect: {
    ...
    exercises: [{ id: "ppf1", type: "multiple_choice", topicKey: "past_perfect", question: "I ___ before dinner.", options: [{ id: "a", text: "had finished", isCorrect: true }, { id: "b", text: "have finished", isCorrect: false }] }]
  },
  conditionals_2_3: {
  ...
  passive_voice_advanced: {
    ...
    exercises: [{ id: "pva1", type: "multiple_choice", topicKey: "passive_voice_advanced", question: "He is said ___ rich.", options: [{ id: "a", text: "to be", isCorrect: true }, { id: "b", text: "being", isCorrect: false }] }]
  },
  relative_clauses: {
    ...
    exercises: [{ id: "rc1", type: "multiple_choice", topicKey: "relative_clauses", question: "The car ___ I bought.", options: [{ id: "a", text: "which", isCorrect: true }, { id: "b", text: "who", isCorrect: false }] }]
  },
  modal_perfect: {
    key: "modal_perfect",
    ...
    exercises: [{ id: "mp1", type: "multiple_choice", topicKey: "modal_perfect", question: "He ___ forgotten.", options: [{ id: "a", text: "must have", isCorrect: true }, { id: "b", text: "must has", isCorrect: false }] }]
  },
  inversion_basic: {
    key: "inversion_basic",
    titleEn: "Inversion",
  ...
  subjunctive: {
    ...
    exercises: [{ id: "sub1", type: "multiple_choice", topicKey: "subjunctive", question: "I insist he ___.", options: [{ id: "a", text: "be", isCorrect: true }, { id: "b", text: "is", isCorrect: false }] }]
  },
  cleft_sentences: {
    key: "cleft_sentences",
  ...
  past_perfect_continuous: {
    ...
    exercises: [{ id: "ppfc1", type: "multiple_choice", topicKey: "past_perfect_continuous", question: "He ___ for hours.", options: [{ id: "a", text: "had been waiting", isCorrect: true }, { id: "b", text: "has been waiting", isCorrect: false }] }]
  },
  mixed_conditionals: {
    ...
    exercises: [{ id: "mix1", type: "multiple_choice", topicKey: "mixed_conditionals", question: "If I ___ born earlier, I'd be old.", options: [{ id: "a", text: "had been", isCorrect: true }, { id: "b", text: "were", isCorrect: false }] }]
  },
  wishes_regrets: {
    key: "wishes_regrets",
  ...
  phrasal_verbs_intro: {
    ...
    exercises: [{ id: "phv1", type: "multiple_choice", topicKey: "phrasal_verbs_intro", question: "Don't ___ up!", options: [{ id: "a", text: "give", isCorrect: true }, { id: "b", text: "take", isCorrect: false }] }]
  },
  ...
  used_to_would: {
    ...
    exercises: [{ id: "utw1", type: "multiple_choice", topicKey: "used_to_would", question: "I ___ live in NY.", options: [{ id: "a", text: "used to", isCorrect: true }, { id: "b", text: "would", isCorrect: false, feedbackRu: "Would не для состояний." }] }]
  },
  stative_verbs: {
    key: "stative_verbs",
    ...
    exercises: [{ id: "sv1", type: "multiple_choice", topicKey: "stative_verbs", question: "I ___ the answer.", options: [{ id: "a", text: "know", isCorrect: true }, { id: "b", text: "am knowing", isCorrect: false }] }]
  },
  linking_words: {
    key: "linking_words",
    ...
    exercises: [{ id: "lw1", type: "multiple_choice", topicKey: "linking_words", question: "___ it was late, I worked.", options: [{ id: "a", text: "Although", isCorrect: true }, { id: "b", text: "But", isCorrect: false }] }]
  }
}
